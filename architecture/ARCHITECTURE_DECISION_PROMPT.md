...
- architecture/SOLUTION_CLASS_TAXONOMY.md (coverage check)
- architecture/ARCHITECTURE_STYLE_MATRIX.md (if comparing styles)
...
- Treat architecture/rag/ notes as advisory only, not normative rules.
